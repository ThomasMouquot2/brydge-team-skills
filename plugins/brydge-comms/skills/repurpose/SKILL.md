...
**Agent names:** these agents ship inside the `brydge-comms` plugin, so spawn them with the plugin prefix: `brydge-comms:repurpose-social`, `brydge-comms:repurpose-visual`, `brydge-comms:repurpose-longform`, `brydge-comms:repurpose-community`, `brydge-comms:repurpose-seo`.
